...
export default function FoodSafety() {
  ...
  const FALLBACK_COLUMNS = {
    ...
    cooking_cooling: [{key:"date",label:"Date",type:"date",required:true},{key:"food",label:"Food",type:"text",required:true},{key:"core_temp",label:"Core Temp (>=75C)",type:"number"},{key:"cooling_start_time",label:"Cooling Start Time",type:"time"},{key:"cooling_start_temp",label:"Cooling Start Temp",type:"number"},{key:"time_2hr",label:"Time at 2hr Check",type:"time"},{key:"temp_2hr",label:"Temp at 2hr (<=21C?)",type:"number"},{key:"temp_2hr_ok",label:"<=21C?",type:"select",options:["Yes","No"]},{key:"temp_within_4hrs",label:"Temp within 4hrs?",type:"number"},{key:"corrective_action",label:"Corrective Action",type:"select",options:["Yes","No"]},{key:"staff_initials",label:"Staff Initials",type:"text",required:true}],
