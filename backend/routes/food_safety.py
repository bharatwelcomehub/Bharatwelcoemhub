...
TEMPLATE_COLUMNS = {
    ...
    "cooking_cooling": [
        ...
        {"key": "cooling_start_time", "label": "Cooling Start Time (60C)", "type": "time"},
        {"key": "temp_2hr", "label": "Temp at 2hr (<=21C?)", "type": "number"},
        {"key": "time_2hr", "label": "Time at 2hr Check", "type": "time"},
        {"key": "temp_5c", "label": "5C or below in 4hrs?", "type": "text"},
    ...
    "food_temp_record": [
        {"key": "date", "label": "Date", "type": "date", "required": True},
        {"key": "time", "label": "Time", "type": "time", "required": True},
        {"key": "cold_unit_1", "label": "Cold Unit 1 (Fridge 1)", "type": "number"},
        {"key": "cold_unit_2", "label": "Cold Unit 2", "type": "number"},
        {"key": "cold_unit_3", "label": "Cold Unit 3", "type": "number"},
        {"key": "hot_unit_1", "label": "Hot Unit 1 (Bain Marie)", "type": "number"},
        {"key": "hot_unit_2", "label": "Hot Unit 2", "type": "number"},
        {"key": "hot_unit_3", "label": "Hot Unit 3", "type": "number"},
        {"key": "notes", "label": "Notes", "type": "text"},
    ...
    "two_four_hour_rule": [
        ...
        {"key": "total_time_out", "label": "Total Time Out", "type": "text"},
